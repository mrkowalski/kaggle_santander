...
indicators_ignored = ['ind_ahor_fin_ult1', 'ind_aval_fin_ult1', 'ind_viv_fin_ult1', 'ind_hip_fin_ult1', 'ind_cder_fin_ult1', 'ind_plan_fin_ult1', 'ind_pres_fin_ult1']
...
#ind_plan_fin_ult1 - 92 activations
#ind_hip_fin_ult1  - 80 activations
#ind_viv_fin_ult1  - 68 activations
#ind_pres_fin_ult1 - 26 activations
